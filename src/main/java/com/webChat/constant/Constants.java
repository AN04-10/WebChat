...
public class Constants {
    ...
    public static final String REDIS_JWT_KEY = "webChat:user:login:";

    //生成唯一数据的redis的key
    public static final String REDIS_ONLY_NUMBER_KEY = "webChat:tran:onlynumber";

    //负责人redis的key
    public static final String REDIS_OWNER_KEY = "webChat:user:owner";
